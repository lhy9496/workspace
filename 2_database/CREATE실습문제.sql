...
--5개 정도의 샘플 데이터 추가하기
INSERT INTO TB_BOOK VALUES(100, '자바정복기', '구구구', 1000000, 1);
INSERT INTO TB_BOOK VALUES(101, '자바정복기2', '구구구', 1000000, 1);
INSERT INTO TB_BOOK VALUES(102, '자바정복기3', '구구구', 2000000, 2);
INSERT INTO TB_BOOK VALUES(103, '자바정복기4', '구구구', 3000000, 3);
INSERT INTO TB_BOOK VALUES(104, '자바정복기5', '구구구', 3000000, 3);
...
CREATE TABLE TB_MEMBER(
    ...
    GENDER CHAR CONSTRAINT MEMBER_CK_GEN CHECK(GENDER IN ('M', 'F')),
    ADDRESS VARCHAR2(30),
    PHONE VARCHAR2(13),
    STATUS CHAR DEFAULT 'N' CONSTRAINT MEMBER_CK_STA CHECK(STATUS IN ('N', 'Y')),
...
INSERT INTO TB_MEMBER VALUES(202, 'USER03', 'PASS01', '최지스리', 'M', NULL, NULL, DEFAULT, DEFAULT);
INSERT INTO TB_MEMBER VALUES(203, 'USER04', 'PASS01', '최지포', 'M', NULL, NULL, DEFAULT, DEFAULT);
INSERT INTO TB_MEMBER VALUES(204, 'USER05', 'PASS01', '최지브이', 'M', NULL, NULL, DEFAULT, DEFAULT);
...
INSERT INTO TB_RENT VALUES(301, 202, 103, DEFAULT);
INSERT INTO TB_RENT VALUES(302, 202, 104, DEFAULT);

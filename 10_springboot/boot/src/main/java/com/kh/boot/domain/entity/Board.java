...
//JPA : java에서 ORM을 위한 표준 인터페이스 및 규약을 정의한 API
//Hibernate : Java 언어로 작성된 객체 관계 매핑(Object-Relational Mapping) 프레임워크
//Sql쿼리를 직접 작성하지 않고도 데이터베이스 연산을 수행할 수 있도록 도와줌


//@Data : getter, setter, toString, equals, hashCode를 포괄한다.
//@Entity : 해당 클래스가 데이터베이스의 테이블과 매핑되는 엔티티 클래스임을 나타낸다.
//@Table : 데이터 베이스로 특정 ㄷ테이르
